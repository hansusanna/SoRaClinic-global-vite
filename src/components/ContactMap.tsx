export default function ContactMap() {
  return (
    <div className="md:self-start bg-white/60 backdrop-blur-sm rounded-3xl overflow-hidden border border-gray-200/50 shadow-lg">
      <iframe
        ...
        className="w-full h-[420px] border-0 transition-all duration-300 md:hover:contrast-110"
      />
    </div>
  )
}
